...
<div class="postmeta clearfix">
	...
	<div class="meta_left">
		...
		<?php the_category(', '); ?><?php if(function_exists("the_tags")) the_tags(' &bull; Tags: ', ', ', ''); ?> <?php if ( comments_open() ) : ?>&bull; <?php endif; ?> - <a href="<?php the_permalink(); ?>" </a> <?php edit_post_link('Edit', ' &#124; ', ''); ?>
	</div>
